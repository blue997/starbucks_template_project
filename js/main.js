...
// 순차적으로 visual 안의 요소를 보여줌
// 이미지 부분 그룹 처리(fade--in)
...
const swiper2=new Swiper(".promotion .swiper",{
  ...
  centeredSlides:true, // 1번 슬라이드를 가운데부터 시작
  loop:true,
  autoplay:{
    delay:5000
  },
  pagination:{
    ...
    clickable:true // 페이지 표시(원)를 클릭하면 해당하는 슬라이드로 이동
  },
  navigation:{
...
const promotionToogleBtn=document.querySelector(".notice .toggle-promotion");
console.log(promotionEl,promotionToogleBtn)
